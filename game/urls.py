...
urlpatterns = [
    ...
    path('pools/<str:pool_id>/join/', PoolJoinView.as_view(),            name='pool-join'),
    path('pools/<str:pool_id>/leaderboard/', PoolLeaderboardView.as_view(), name='pool-leaderboard'),
    ...
    path('admin/pools/<str:pool_id>/start/', AdminPoolStartView.as_view(), name='admin-pool-start'),
    ...
    path('admin/users/<str:user_id>/adjust-wallet/', AdminWalletAdjustView.as_view(), name='admin-adjust-wallet'),
